...
int execute_print(const char *fmt, int *i,
va_list list, char buffer[], int flags, int width, int precision, int size);

/****************** FUNCTIONS ******************/

/* Funtions to print chars and strings */
int print_char(va_list lsts, char buffer[],
...
int print_binary(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int print_myunsigned(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int prt_octal(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int print_hxdecimal(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int print_hex_upp(va_list types, char buffer[],
	int flags, int width, int precision, int size);
...
int print_pntr(va_list types, char buffer[],
	int flags, int width, int precision, int size);
...
int print_rvrs(va_list types, char buffer[],
	int flags, int width, int precision, int size);
...
int affixhexacode(char, char[], int);
