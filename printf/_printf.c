 ...
 * Return: Will return printed results in char.
 */
...
/**
 * print_buffer - Will prints contents of the buffer if it exists.
 * @buffer: An array of chars
 * @buff_ind: The index at which to add  next char representing length.
 */
